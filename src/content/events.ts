...
// To insert an event image, set the `cover` field to:
// cover: "/assets/events/your-image.jpg"
// If not yet available, keep "[SPARK-EVENT-01-COVER]" to render the placeholder.
// ============================================================================
...
export const pastEvents: SparkEvent[] = [
  {
    ...
    topics: ["Finance", "Awareness", "Smart Decisions"],
    cover: "[SPARK-EVENT-01-COVER]", // INSERT IMAGE HERE -> "/assets/events/financial-literacy.jpg"
  ...
  },
  {
    ...
    topics: ["Practical", "Beginner Friendly", "Skill Building"],
    cover: "[SPARK-EVENT-02-COVER]", // INSERT IMAGE HERE -> "/assets/events/soldering-workshop.jpg"
  ...
  },
  {
    ...
    topics: ["Hands-on", "Interactive", "Industry Insights"],
    cover: "[SPARK-EVENT-03-COVER]", // INSERT IMAGE HERE -> "/assets/events/ar-vr-workshop.jpg"
...
export const upcoming: UpcomingEvents = {
  ...
  note: "Stay tuned for society updates and registration links.",
};
